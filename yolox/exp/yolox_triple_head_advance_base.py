...
class TripleHeadExpAdvance(BaseExp):
    def __init__(self):
        super().__init__()
    ...
    def get_model(self):
        from yolox.models import YOLOPAFPN, YOLOXTripleHeadAdvance, YOLOXHead
        ...
        if getattr(self, "model", None) is None:
            ...
            self.model = YOLOXTripleHeadAdvance(backbone, head, extra_head, extra_head_1)
