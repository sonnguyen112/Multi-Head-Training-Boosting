...
class TeacherStudentTrainer:
    def __init__(self, exp, t_exp, args):
    ...
    def before_train(self):
        ...
        t_model = self.t_exp.get_model()
        logger.info(
            "Model Summary: {}".format(get_model_info(model, self.exp.test_size))
        )
        logger.info(
            "Teacher Model Summary: {}".format(get_model_info(t_model, self.t_exp.test_size))
        )
        ...
        t_model = self.init_teacher_model(t_model)
        ...
        if self.is_distributed:
            ...
            t_model = DDP(t_model, device_ids=[self.local_rank], broadcast_buffers=False)
