...
if __name__ == '__main__':
    ...
    data_root = '/root/Thesis/ByteTrack/datasets/mot/test'
    txt_path = '/root/Thesis/ByteTrack/YOLOX_outputs/yolox_s_with_head_l_head_x_mix_det/track_results'
    save_path = '/root/Thesis/ByteTrack/YOLOX_outputs/yolox_s_with_head_l_head_x_mix_det/track_results_dti'
